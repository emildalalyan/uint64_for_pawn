...
позволяет "поднять планку" максимума (2^64 = **18 446 744 073 709 551 615**)
...
Несмотря на оптимизацию операций *(например, некоторые функции были переписаны на AMX ассемблере)*,
